...
단, (ii-b) 위임 불가 Halt(파괴적·외부/비가역·인증정보 필요 신규 외부 서비스·돌발 결정)가 명시된 task는 그 Halt 지점에서 승인을 위해 멈추는 것이 정상이며, 질문 3의 "추가 질문"이나 "준비도 미달"에 해당하지 않는다. **(ii-a) 사전 승인 항목은 plan 승인에 일괄 포함돼 그 지점에서 멈추지 않는다.** **(ii-c) 완료 후 일괄 승인 항목도 마찬가지로 멈추지 않는다** — 루프가 그 작업을 하지 않은 채 지나가고 승인은 최종 보고가 모아 받는다. (자율 루프는 (ii-b)에서만 공시 후 멈추고, 그 외 전 구간은 멈춤 없이 진행한다.)
