...
>
> **이 단계의 질문은 Step 9 일괄 질문과 별개다.** 작업 공간 정리는 계획을 시작하기 *전에* 끝나야 하는 선결 조건이므로(미정리 상태로 계획을 쓰면 안 됨), Step 9로 미루지 않고 여기서 즉시 묻고 처리한다.
...
- 디자인 요소가 애매한 경우(예: 정확한 색·간격 미확정)는 여기서 즉시 묻지 말고, Step 9 일괄 질문에 모아서 처리한다 (질문 분산 방지).
