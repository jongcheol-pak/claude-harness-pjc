...
- **BLOCKER·MAJOR는 고치고 다시 호출한다. MINOR도 「지금 고칠 것인가」 3조건을 통과하면 고치고 재호출하며, 어긋난 것만 `## Deferred / Follow-up`에 적는다**(정본 `../../plan/references/plan-template.md` 「Deferred / Follow-up」). **그중 등재 하한선(실해 관측)에 미달하는 것은 등재하지 않고 `[미등재:실해 없음]`으로 닫는다** — 이번 회차가 낸 흠을 다음 회차에 넘기는 것은 처리가 아니라 전가다.
