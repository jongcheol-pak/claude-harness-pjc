...
- **행 형식(4컬럼)**: `| 증상(관찰 표현) | 근본원인(1줄·검증) | 플랫폼 | [[경로\|해법]] |` — 첫 컬럼(증상)은 **평문**(§3 기능별 인덱스 행 형식과 동형).
- **등재 게이트 (3개 전부 충족 시에만)**:
