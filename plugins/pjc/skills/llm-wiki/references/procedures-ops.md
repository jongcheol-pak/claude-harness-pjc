...
30. `[기계]` 이동·분리 도달 경로 정합 (§7-30 — ⓐ 허브 `## 아카이브` 포인터 ↔ `changes.md` 양방향 ⓑ `conventions.md` `## 하위 문서` 목록 ↔ 하위 파일 양방향 ⓒ guide·entity·concept의 인덱스 등록 ⓓ guide 허브 `## 하위 문서` ↔ 하위 양방향(복귀 링크 기준). `--fix` 비대상)
