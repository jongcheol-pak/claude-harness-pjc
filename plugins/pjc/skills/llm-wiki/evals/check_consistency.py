...
TRIGGER_ALLOWLIST = [
    ...
    (LINT_CASES_JSON, ['"rationale": "§7-2 임박 단계(WARN)', "— 임박 판정의 OR 두 항을", "INFO로 내려가지 않고 임박 WARN에서 멈춘다", "경로의 임박 분기 회귀다", "이 경로에는 원래 임박 계층이 없어", "근접을 폐지하면서 임박 분기를 신설했다"], "임박 OR 두 항 케이스 실증 서술"),
