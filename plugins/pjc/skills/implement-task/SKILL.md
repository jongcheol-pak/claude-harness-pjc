...
**이 유형의 함정**: **예고 자체가 금지가 아니라 *예고를 마지막 말로 남기고 turn을 끝내는 것*이 금지다.** ①과 달리 질문이 아니어서 *"묻지 않았다"* 는 규칙은 지킨 것처럼 보이는데, 결과는 확인 요청과 똑같은 루프 정지다. 실측: *"여기까지 진행 상황을 정리 합니다. 계속 T5부터 이어서 진행하겠습니다."* 를 출력하고 멈췄다.
...
**이 유형의 함정**: ②는 "진행하겠다"는 예고라도 남기지만 ⑤는 **완료 사실만 서술**해 규칙을 어긴 흔적조차 없어 보인다. 게다가 진행 상황을 서술하는 방식은 무한하고("T9~T13을 **진행했습니다**"·"상황을 **정리해 보고합니다**"·"여기까지의 결과를 **공유합니다**"), **①이 권장하는 한 줄 완료 마커가 그대로 정지 문구가 될 수 있어** 다섯 유형 중 가장 잘 발생한다. 사용자가 *"중간 보고를 하면 무조건 자율루프가 멈춘다"* 로 보고한 현상이 이것이다.
