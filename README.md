...
- **검토자는 읽기만 합니다**: 계획·코드 검토자 6종은 파일을 고칠 수 없게 정의돼 있고(`Write`·`Edit` 제거), 지적을 반영하는 것은 Claude 본체입니다. 그래서 검토자가 파일을 고치려 하면 쓰기 오류가 나는데 **그것이 설계된 동작**입니다 — 검토와 수정의 주체를 나눠야 "자기가 쓴 것을 자기가 통과시키는" 경로가 막힙니다.
