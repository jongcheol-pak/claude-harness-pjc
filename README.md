...
- **프로젝트 안내 문서가 커지면 옮깁니다**: `AGENTS.md`가 세션 주입 상한에 닿으면 큰 절을 다른 문서로 옮기고 그 자리에 안내 한 줄을 남깁니다. 빌드·테스트 명령과 금지 항목은 **항상 그 파일에 남습니다** — 세션이 그것을 잃으면 빌드도 못 하고 금지선도 모릅니다.
